    ...
    >
      <Stack gap={3}>
        <LinkContainer to={`posts/${posts._id}`}>
          <Container id="post-cover-img-container">
            <img
              alt="postImage"
              style={{
                width: "100%",
        ...
        <Container id="post-cover-like-comment">
          <Row style={{ width: "fit-content", fontSize: "12px" }}>
            <Col>
              ...
              <h3 style={{ display: "inline" }}>{posts.likes.length}</h3>
            </Col>
            <Col>
              <FontAwesomeIcon icon={faComment} size="2x" />
              <h3 style={{ display: "inline" }}>{posts.comments.length}</h3>
            </Col>
          </Row>
        </Container>
      </Stack>
