...
const CodeOfConduct = () => {
    return (
        <Container style={{ marginTop: '6rem' }}>
            ...
            <p>All participants of HowTo Community are expected to abide by our Code of Conduct, both online and during in-person events that are hosted and/or associated with HowTo Community.
            ...
            <p>
                In the interest of fostering an open and welcoming environment, we as moderators of HowTo Community pledge to make participation in our project and our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.
            </p>
            ...
            <ul>
                ...
                <li>Dismissing or attacking inclusion-oriented requests
                </li>
            ...
            <p>
                Violations of the Code of Conduct may be reported by contacting the team via the abuse report form or by sending an email to yo@HowTo.to. All reports will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. Further details of specific enforcement policies may be posted separately.
