...
import { getUserDetails, updateUserProfile, getUserMyPosts } from '../actions/userActions'
...
const ProfileScreen = () => {
    ...
    }, [dispatch, user, userInfo, navigate, myposts, successDelete, successCreate])
                ...
                <Row>
                    <Col md={3}>
                        ...
                        {loading ? (<Loader />) : error ? (<h2>{error}</h2>) : (
                            <><Row style={{ justifyContent: 'center', margin: '2rem' }}><img alt="postAvatar" className="rounded-circle border border-dark shadow" src={avatar} style={{ width: '100px', height: '100px' }}></img></Row><Row>
                    ...
                    <Col md={9}>
                        ...
                        {loadingMyPosts ? (
                            ...
                            <> <Row style={{ marginTop: '2rem' }}><LinkContainer to='/addpost'><Button variant="outline-primary">AddPost</Button></LinkContainer></Row>
