        ...
        <Container id='home-container' style={{ marginTop: '6rem' }}>
            <Row>
                <Col className='col-12 mb-4 col-lg-3'>
                    ...
                    <Stack gap={3}>
                        <div style={{ border: '1px solid lightgrey', borderRadius: '10px', boxShadow: '0 0 1px #333', padding: '1rem' }}>
                            <h4><b>HowTo Community is a community of 251,255 amazing developers.</b></h4>
                            <h5>We're a place where coders share, stay up-to-date and grow their careers</h5>
                        </div>
                ...
                <Col className='col-12 mb-4 col-lg-3'>
                    <Container style={{ border: '1px solid lightgrey', padding: '1rem', borderRadius: '10px', boxShadow: '0 0 1px #333' }}>
                        <h4>
